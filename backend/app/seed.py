...
from .models import User, Profile, Document, Service, Scheme, Complaint, Application, Deadline, Notification, BusinessTemplate, LifeEvent, Checklist
...
def seed_data(db: Session):
    ...
    services = [
        ...
        Service(
            title="Birth Certificate Registry",
            description="Register a birth and obtain an official birth certificate.",
            category="Certificates",
            eligibility="Parents or legal guardians of a child born within municipal limits.",
    ...
    print("DB Seeding completed successfully. Seeded 31 services, 21 schemes, 6 business models, 8 life events, 5 users, and 10 Bengaluru complaints.")
